...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="row mb-5">
                <label class="col-lg-4 form-label nullable">{{ __('messages.user.full_name').':' }}</label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    {{ Form::text('dob', $user->dob, ['class'=> 'form-control', 'placeholder' =>__('messages.doctor.dob'), 'nullable']) }}
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6">
                                    {{ Form::text('countryid', $user->countryid ) }}
                                    <div class="invalid-feedback"></div>    
                                </div>
                                <div class="col-lg-6">
                                    {{ Form::text('stateid', $user->stateid ) }}
                                    <div class="invalid-feedback"></div>    
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6"><label>title : </label>
                                    {{ Form::text('title', $user->title ) }}
                                    <div class="invalid-feedback"></div>    
                                </div>
                                <div class="col-lg-6"><label>Description : </label>
                    ...
                    <div class="row mb-5">
                        <label class="col-lg-4 form-label required">{{ __('messages.user.email').':' }}</label>
                        <div class="col-lg-8">
                            {{ Form::email('gender', $user->gender, ['class'=> 'form-control', 'placeholder' => __('messages.user.email'), 'required']) }}
                        </div>
                    </div>
                     --}}
