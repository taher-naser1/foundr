...
@section('content')
    <div class="d-flex flex-column flex-column-fluid align-items-center justify-content-center p-4">
        ...
        <div class="bg-white rounded-15 shadow-md width-540 px-5 px-sm-7 py-10 mx-auto">
            ...
            <form method="POST" action="{{ route('register') }}" id ="createPatientForm" files = 'true'>
                @csrf
                <div class="row">
                                ...
                                <div class="image-picker">
                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                        ...
                                        <label> 
                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i> 
                                            <input type="file"  class="custom-file-input" id="profilePicture" name="profile" accept="">
                                            <input type="file" name="profile" id="profilePicture" class="image-upload d-none " accept=""  style="background-image: url({{ !empty($patient->profile) ? $patient->profile : asset('web/media/avatars/cccc.png') }} "/> 
                                        </label> 
                                    </span>
