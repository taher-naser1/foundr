...
Route::prefix('doctors')->name('doctors.')->middleware('auth', 'xss', 'checkUserStatus', 'role:doctor')->group(function () {
    ...
    Route::get('appointmentscount', [DoctorDayController::class, 'countAppointmentsDoctor'])->name('appointmentscount');
    Route::get('summationpayable', [DoctorDayController::class, 'sumPayableAmountsDoctor'])->name('summationpayable');


//----------------------monthly appointments and summation of prices------------------------------------
Route::get('countAppointmentsDoctorMonthly', [DoctorDayController::class, 'countAppointmentsDoctorMonthly'])->name('countAppointmentsDoctorMonthly');
Route::get('sumPayableAmountsDoctorMonthly', [DoctorDayController::class, 'sumPayableAmountsDoctorMonthly'])->name('sumPayableAmountsDoctorMonthly');
