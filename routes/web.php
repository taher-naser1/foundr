...
use App\Http\Controllers\NewPresController;
...
use App\Http\Controllers\ViewDoctorController;
...
//---------------test
Route::resource('doctor-day', DoctorDayController::class);
...
Route::get('/doctorspatient', [ViewDoctorController::class,'index']);
Route::get('/doctorpatientdetails/{doctor}', [ViewDoctorController::class,'show'])->name('doctorpatientdetails');
Route::get('/specializationfilter', [ViewDoctorController::class,'specializationfilter'])->name('specializationfilter');


//--------------------------------services filter--------------------
Route::get('/doctors/activated-service/{serviceId}',  [UserController::class,'doctorsWithActivatedService']);
...
//---------------------------filter search------------------------------------
Route::get('/searchdoctor', [ViewDoctorController::class,'searchfilter'])->name('searchdoctor');


//--------------------------NewPrescription------------------------
Route::get('newpres/show/{appointmentId}', [NewPresController::class,'show'])->name('newpres.show');
Route::get('newpres/create', [NewPresController::class,'create'])->name('newpres.create');
Route::post('newpres/store', [NewPresController::class,'store'])->name('newpres.store');
Route::get('newpres/edit/{id}', [NewPresController::class,'edit'])->name('newpres.edit');
Route::put('newpres/edit/{id}', [NewPresController::class,'update'])->name('newpres.update');



Route::get('getDrugsForAppointment/{appointmentid}', [NewPresController::class,'getDrugsForAppointment']);
Route::get('pres/delete/{id}', [NewPresController::class,'destroy']);


//Route::livewire('/doctor-table-show', 'doctor-table-show');
