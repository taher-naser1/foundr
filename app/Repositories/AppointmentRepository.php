     ...
     public function store($input)
    {
        try {
          ...
          //  $fromTime = explode(' ', $input['from_time']);
           ...
           // $input['from_time'] = null;
           // $input['from_time_type'] = null;
           // $input['to_time'] = null;
           // $input['to_time_type'] = null;
          /*
    ...
    */
    ...
    public function store($input)
    {
        try {
            ...
            $input['payment_type'] = Appointment::MANUALLY;
            $input['payment_method'] = Appointment::MANUALLY;
            $serviceDoctor = ServiceDoctor::where('service_id', $input['service_id'])
                ->where('doctor_id', $input['doctor_id'])
                ->first();

            if ($serviceDoctor) {
                // Use the price from the ServiceDoctor record
                $input['payable_amount'] = $serviceDoctor->price;
            }
            $input['from_time'];
            $input['to_time'];
            $input['from_time_type'];
            $input['to_time_type'];
